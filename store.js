...
export const receiveSettings = (shop, data, settings, stats) => {
  return {
...
export const successSavingQuestion = (data) => {
  ...
  let foundIndex = newSettings.questions.findIndex(
...
export const successSavingOption = (data) => {
  ...
  let newSettings = data.settings;
  let foundIndex = newSettings.resultOptions.findIndex(
    (x) => x._id == data.option._id
  );
